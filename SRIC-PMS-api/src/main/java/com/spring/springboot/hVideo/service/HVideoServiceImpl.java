...
import com.spring.springboot.hVideo.mapper.HVideoMapper;
...
public class HVideoServiceImpl implements HVideoService
{
    ...
    public List<HVideo> getHVideoList(HVideoRequestPojo hVideoRequest)
    {
        ...
        for(int i = 0;i < hVideoList.size();i++)//遍历设置封面
        {
            String coverPath = hFilesPath + "/hVideoCover/" + hVideoList.get(i).getId() + ".webp";
