package com.spring.springboot.permissionRequest.mapper;
...
public interface PermissionRequestMapper
{
     ...
     */
    @Select(value = "SELECT COUNT(*) FROM `permission_request` WHERE request_mapping = #{requestMapping} AND uuid != #{uuid}")
