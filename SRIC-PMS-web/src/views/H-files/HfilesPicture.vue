...
<script lang="ts" setup>
    ...
    const addPicture = (id:any,filename:any): Promise<void> => //向高度更小的一边添加名为filename的图片
    {
        return new Promise((resolve) => {
            ...
            img.onload = () => {
                ...
                if (leftContainer && rightContainer) {
                    ...
                    if (leftHeight > rightHeight) {
                        urlRight.value.push(axios.defaults.baseURL + "/static/hFile/hPicture/" + id + "." + filename);
                    } else {
                        urlLeft.value.push(axios.defaults.baseURL + "/static/hFile/hPicture/" + id + "." + filename);
                    }
            ...
            img.src = axios.defaults.baseURL + "/static/hFile/hPicture/" + id + "." + filename;
        });
    };
